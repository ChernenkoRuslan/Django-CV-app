...
class ModelDetected:
    ...
    def model_predict(self, img_files: list, zone_name: str, output_dir_zone: str):
        self.alpha = 0.2
        danger_zone = self.danger_zones[f"danger_{zone_name}"]
        ...
        for imgage_file in img_files:
            ...
            for idx in range(len(boxes)):
                ...
                if is_segments:
                    ...
                    segment_person_warning = segment_polygon_intersection / Polygon(segment).area
...
if __name__ == '__main__':
    ...
    test_zone = 'Pgp-com2-K-1-0-9-36'
    test_file = CAMERAS_PATH + f'{test_zone}/Pgp-com2-K-1-0-9-36_PU-13_obshchiy_vid_A-B_kol_23_27_03_2021_23_40_57_192_.jpg'
